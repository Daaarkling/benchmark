...
public class PersonCollection extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public PersonCollection(java.util.List<benchmark.java.metrics.avro.Person> persons) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: persons = (java.util.List<benchmark.java.metrics.avro.Person>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.util.List<benchmark.java.metrics.avro.Person> getPersons() {
    return persons;
  }
   ...
   */
  public void setPersons(java.util.List<benchmark.java.metrics.avro.Person> value) {
    this.persons = value;
  }
   ...
   */
  public static benchmark.java.metrics.avro.PersonCollection.Builder newBuilder() {
    return new benchmark.java.metrics.avro.PersonCollection.Builder();
  }
   ...
   * @return A new PersonCollection RecordBuilder
   */
  public static benchmark.java.metrics.avro.PersonCollection.Builder newBuilder(benchmark.java.metrics.avro.PersonCollection.Builder other) {
    return new benchmark.java.metrics.avro.PersonCollection.Builder(other);
  }
   ...
   * @return A new PersonCollection RecordBuilder
   */
  public static benchmark.java.metrics.avro.PersonCollection.Builder newBuilder(benchmark.java.metrics.avro.PersonCollection other) {
    return new benchmark.java.metrics.avro.PersonCollection.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PersonCollection>
    ...
    private java.util.List<benchmark.java.metrics.avro.Person> persons;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(benchmark.java.metrics.avro.PersonCollection.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(benchmark.java.metrics.avro.PersonCollection other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.persons)) {
        this.persons = data().deepCopy(fields()[0].schema(), other.persons);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public benchmark.java.metrics.avro.PersonCollection.Builder setPersons(java.util.List<benchmark.java.metrics.avro.Person> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public benchmark.java.metrics.avro.PersonCollection.Builder clearPersons() {
      persons = null;
    ...
    public PersonCollection build() {
      try {
        ...
        record.persons = fieldSetFlags()[0] ? this.persons : (java.util.List<benchmark.java.metrics.avro.Person>) defaultValue(fields()[0]);
        return record;
      } catch (Exception e) {
